...
def get_entry_radar_xml(id: int, request: Request):
    ...
    return templates.TemplateResponse(request=request, name="entry.radar.xml", context={"entry": entries[0]}, media_type='application/xml')


@explorer_router.get('/licenses.html')
def get_licenses(request: Request,  license_id: int | None = None):
    # call the function
    try:
    ...
    if license_id is not None:
        ...
        return templates.TemplateResponse(request=request, name="licenses.html", context={"licenses": licenses})


@explorer_router.get('/authors.html')
@explorer_router.get('/entries/{entry_id}/authors.html')
def get_authors(request: Request, entry_id: int | None = None, author_id: int | None = None, search: str = None, exclude_ids: list[int] = None, target: str = None, offset: int = None, limit: int = None):
    try:
...
def get_variables(request: Request, offset: int = None, limit: int = None):
    try:
